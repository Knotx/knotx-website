...
## Set up the project
Clone [Knot.x Data Bridge](https://github.com/Knotx/knotx-data-bridge) and switch to release tag `1.5.1`
                                                                        
```
git checkout tags/1.5.1
```

Copy module `knotx-data-bridge/how-to-extend/adapter-starterkit` to separate folder and open in IDE.
It's separate module with basic code example of extending Knot.x Data Bridge. You can find details about content of module in [Readme](https://github.com/Knotx/knotx-data-bridge/tree/master/how-to-extend). 
...
In section _Plug in the Custom Data Source Adapter_ we will plug our custom code to the `Knot.x Stack` instance
...
available in [Knot.x example project](https://github.com/Knotx/knotx-example-project). Clone it and check  how it works. Before you start, remember to switch into correct tag 1.5.1
