...
It's an [OpenAPI 3.0](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.0.md) specification file that exposes APIs.
...
We can see three distinguishable parts of this file:
 ...
 3.  Paths configuration that explicitly specifies our endpoints, their paths, methods, responses and much more in a clear, easily readable and declarative way:
      ...
      ...
      ```
      Our Starter Kit template comes with example paths and methods defined. Let's see the `/healthcheck` API. It is used to express the current state of our application in very simple terms: UP or DOWN.
...
Now that, we know what's going on in this file, let's define our custom endpoint.
