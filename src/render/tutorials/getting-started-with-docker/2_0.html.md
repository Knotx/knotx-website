...
In this tutorial, we will set up a simple project based on the [Knot.x Starter Kit](https://github.com/Knotx/knotx-starter-kit) template, just as we did in [the previous tutorial](http://knotx.io/tutorials/getting-started-with-knotx-stack/2_0/), but this time we will use [Docker](https://www.docker.com/).

This is the second part of *Getting started* tutorials, and completion of [Getting Started with Knot.x Stack tutorial](http://knotx.io/tutorials/getting-started-with-knotx-stack/2_0/) is **required** to fully understand this tutorial.
